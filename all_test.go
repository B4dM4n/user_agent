...
var uastrings = []struct {
	...
	{"IE11ProcessingPAC", "Mozilla/5.0 (compatible; IE 11.0; Win64; Trident/7.0)"},
...
var expected = []string{
	...
	// Internet Explorer
	"Mozilla:5.0 Platform:Windows OS:Windows 8 Browser:Internet Explorer-10.0 Engine:Trident-6.0 Bot:false Mobile:false",
	"Mozilla:4.0 Platform:Windows OS:Windows 8 Browser:Internet Explorer-10.0 Engine:Trident-6.0 Bot:false Mobile:false",
	"Mozilla:5.0 Platform:Windows OS:Windows 8 Browser:Internet Explorer-10.0 Engine:Trident-6.0 Bot:false Mobile:false",
	"Mozilla:4.0 Platform:Windows OS:Windows Phone OS 7.0 Browser:Internet Explorer-7.0 Engine:Trident-3.1 Bot:false Mobile:true",
	"Mozilla:4.0 Platform:Windows OS:Windows 2000 Browser:Internet Explorer-6.0 Engine:Trident Bot:false Mobile:false",
	"Mozilla:4.0 Platform:Windows OS:Windows 7 Browser:Internet Explorer-8.0 Engine:Trident-4.0 Bot:false Mobile:false",
	"Mozilla:4.0 Platform:Windows OS:Windows 7 Browser:Internet Explorer-10.0 Engine:Trident-6.0 Bot:false Mobile:false",
	"Mozilla:5.0 Platform:Windows OS:Windows 8.1 Browser:Internet Explorer-11.0 Engine:Trident-7.0 Bot:false Mobile:false",
	"Mozilla:5.0 Platform:Windows OS:Windows 7 Browser:Internet Explorer-11.0 Engine:Trident-7.0 Bot:false Mobile:false",
	"Mozilla:5.0 Platform:Windows OS:Windows 7 Browser:Internet Explorer-11.0 Engine:Trident-7.0 Bot:false Mobile:false",
	"Mozilla:5.0 Platform:Windows OS:Windows 7 Browser:Internet Explorer-11.0 Engine:Trident-7.0 Bot:false Mobile:false",
	"Mozilla:4.0 Platform:Windows OS:Windows 8.1 Browser:Internet Explorer-11.0 Engine:Trident-7.0 Bot:false Mobile:false",
	"Mozilla:5.0 Platform:Windows OS:Windows Browser:Internet Explorer-11.0 Engine:Trident-7.0 Bot:false Mobile:false",
	...
	// Windows services
	"Platform:Windows OS:Windows Browser:WinHttpAutoproxyService-5.1 Bot:false Mobile:false",
	"Platform:Windows OS:Windows Browser:WNS Bot:false Mobile:false",
	"Platform:Windows OS:Windows Browser:NCSI Bot:false Mobile:false",
}
